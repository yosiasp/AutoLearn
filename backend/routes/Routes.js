...
import { chatWithOllama, getOllamaHistory, getChatList, getChatHistory, createNewChat } from "../controller/OllamaController.js";
...
router.post("/:userId/ollama/chat/new", createNewChat);
router.get("/:userId/ollama/chat/:chatId", getChatHistory);
